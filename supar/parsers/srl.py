...
from supar.models import VISemanticDependencyModel as VISemanticRoleLabelingModel
...
class VISemanticRoleLabelingParser(Parser):
    r"""
    The implementation of Semantic Role Labeling Parser using Variational Inference :cite:`li-etal-2020-high`.
    """
